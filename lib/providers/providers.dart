...
final _demoVideos = [
  Video(
    ...
    description: '14分の筋トレ×キックで効率よく脂肪燃焼。オンライントレーニング風景です。',
  ...
  Video(
    ...
    description: '自宅で15分、お尻にしっかり効く下半身トレーニング。オンライントレーニング風景です。',
...
final _demoChapters = <String, List<Chapter>>{};

final _demoCourses = [
  Course(
    id: 'course1',
    title: 'オンラインフィットネス入門',
    description: 'キックボクシングと自重トレーニングを組み合わせた、自宅でできるフィットネスプログラム。',
    thumbnailUrl: 'https://img.youtube.com/vi/TeMPE3PJx2Y/0.jpg',
    categoryId: 'workout',
...
// 現時点ではライブ配信の予定なし。将来 schedule が決まったらここに追加する。
final _demoLiveSchedules = <LiveSchedule>[];
